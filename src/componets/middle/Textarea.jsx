  ...
  return (
    <div>
      <form className='relative flex gap-2 justify-center'>
        <input 
        onClick={inputclickhandel} value={text} onChange={changehandler} className=' p-4 my-2 rounded-lg' type="text" placeholder='Ente your Message' />
        ...
        <button type='submit' className=' bg-green-400 px-4 rounded-lg' >Send</button>
      </form>
    </div>
  )
}
